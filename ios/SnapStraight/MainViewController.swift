    ...
    @objc private func takePhotoTapped() {
        checkCameraPermission { [weak self] granted in
            if granted {
                ...
                self?.showPermissionAlert(message: NSLocalizedString("permission_camera", comment: ""))
            }
        }
    }
    ...
    @objc private func selectPhotoTapped() {
        checkPhotoLibraryPermission { [weak self] granted in
            if granted {
                ...
                self?.showPermissionAlert(message: NSLocalizedString("permission_storage", comment: ""))
            }
        }
    }
